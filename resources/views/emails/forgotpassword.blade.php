    ...
    <div class="bg-blue">
        ...
        <div class="container">
            <div class="inner-body">
                ...
                <br>
                <hr>
                <p>Jika Anda kesulitan mengakses tombol "Reset Password", salin dan tempel URL di bawah ini ke browser web Anda: <a href="{{ url('reset/password/' . $token) }}">{{ url('reset/password/' . $token) }}</a></p>
