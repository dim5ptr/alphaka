  ...
  <nav class="main-header navbar navbar-expand" style="background-color: #e2e4fb;">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="font-size: 25px; color: #7773d4;">
        ...
        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="{{ route('personal') }}">Settings</a>
    ...
    <div class="sidebar my-5 sidebar-collapse">
      ...
      <nav>
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <li class="nav-item">
            <a href="{{ route('dashboard') }}" class="nav-link active" style="background-color: #7773d4;">
          ...
          <li class="nav-item">
            <a href="{{route('organization')}}" class="nav-link active" style="background-color: #7773d4;">
