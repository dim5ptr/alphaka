            ...
            <div class="container">
                ...
                <form action="{{ route('updateProduct') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" name="product_type" id="product_type" value="{{ $product['product_type'] }}" required>
                    </div>

                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="enabled" id="enabled" {{ $product['enabled'] ? 'checked' : '' }}>
