...
<div class="content-header bg-light p-4 shadow-sm rounded" style="margin-bottom: 2%;">
    <div class="container-fluid">
        <div class="row mb-2 align-items-center">
            <div class="col-sm-6">
                <h1 class="m-0" style="color: #0077FF; font-weight: bold; font-size: 2rem;">Licenses</h1>
            </div>
        </div>
    </div>
</div>
...
function showLicenseDetails(licenseId) {
    ...
    const apiUrl = 'http://192.168.1.170:14041/api/license/get_license_data_by_id.json';
