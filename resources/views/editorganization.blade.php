        ...
        <div id="stepModal" class="modal">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h3>How to edit organization?</h3>
                    <div class="steps">
						<div class="step">
							<div class="step-number">1</div>
							<p class="step-instruction">Change your organization name or description as you like, then click the "Save Changes" button.</p>
						</div>
						<div class="step">
							<div class="step-number">2</div>
							<p class="step-instruction">A success message will appear on your organization list page, if the changes were saved successfully </p>
						</div>
						<div class="step">
							<div class="step-number">3</div>
							<p class="step-instruction">Check the organization you just changed, if it hasn't changed correctly, immediately contact the developer or service</p>
						</div>
                    </div>
                </div>
            </div>
